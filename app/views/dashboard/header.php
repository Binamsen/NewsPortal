                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="profile-ava">
                                <img alt="" src="<?php echo URL; ?>public/img/admin.png">
                            </span>
                            <span class="username"><?php echo $_SESSION['adminuser']; ?></span>
                            <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu extended logout">
                            <div class="log-arrow-up"></div>
                            <li class="eborder-top">
                                <a href="<?php echo URL;?>adminprofile"><i class="icon_profile"></i> My Profile</a>
                            </li>
